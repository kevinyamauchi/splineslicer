...
from .measure_boundaries import find_boundaries_from_layer, update_metadata, measure_boundaries
...
class QtUpdatedMeasurements(QWidget):
    def __init__(self, napari_viewer: napari.Viewer):
        ...
        self.load_data_widget = magicgui.magicgui(
            self.load_data,
            final_output_path={
        ...
        self._update_widget = magicgui.magicgui(
            update_metadata,
